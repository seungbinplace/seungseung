...
/*
   주석을 여러줄로 넣을 때는 이런 방식으로 넣는다.
*/

console.log("안녕하세요");
console.error('에러메시지 만들기');
console.warn('경고메시지 만들기');
...
//  snake case : 밑줄(underscore)를 활용한 변수명 짓는 방법
...
//camel case : 낙타등같이 생겼다고해서 camel case
let thisIsUserName;
